-- Extend the analytics trigger to also skip admin and contributor users.
-- This is a defense-in-depth measure; the primary guard is in the client.
...
BEGIN
  IF NEW.user_id IS NOT NULL THEN
    ...
    -- Skip synthetic / tester accounts
    IF v_is_synthetic THEN
      RETURN NEW;
    END IF;

    -- Skip admins and contributors
