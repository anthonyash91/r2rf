...
import {
  ...
  FacilityReportTab,
} from "@/components/analytics/AnalyticsFacilityView";
...
function AdminReportsPage() {
  ...
  const [selectedFacility, setSelectedFacility] = useState<{ value: string; label: string } | null>(
    null,
  );
                ...
                {isFacilityUser ? (
                  <TabsTrigger
                    ...
                    onPointerDown={(e) => {
                      ...
                      setSelectedUserFacility({
                        value: myFacilityValue ?? "__all__",
                        label: myFacilityValue ?? "My Facility",
                      });
                      setUserKey((k) => k + 1);
                      setActiveUser(null);
                      setTab("user");
                  ...
                  >
                    ...
                    >
                      ...
                      <FacilityCombobox
                        value={
                          selectedUserFacility?.value && selectedUserFacility.value !== "__all__"
                            ? selectedUserFacility.value
                            : ""
                        }
                        onChange={(v) => {
                          const f = facilities.find((x) => x.value === v);
          ...
          <TabsContent value="overall" className="mt-8">
            {isFacilityUser && myFacilityValue ? (
              <UsageReportView
                scope={{
                  kind: "facility",
                  facilityValue: myFacilityValue,
                  facilityLabel: myFacilityValue,
                }}
              />
            ) : (
              <>
