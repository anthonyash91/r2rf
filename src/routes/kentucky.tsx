...
const RESOURCES: Resource[] = [
  ...
  {
    id: 526,
    name: "Prodigal Ministries — Buckner",
    category: "Housing",
    description: "Faith-based transitional housing and reentry support for men leaving incarceration. Located in Buckner in Oldham County, the program provides structured sober living, case management, job-readiness coaching, and spiritual mentorship. Accepts residents with felony records.",
    description_es: "Vivienda transitoria de base religiosa y apoyo de reintegración para hombres que salen de la cárcel. Ubicado en Buckner, el programa ofrece vivienda sobria estructurada, gestión de casos, preparación laboral y mentoría espiritual. Acepta residentes con antecedentes penales.",
    address: "5808 KY-146",
    city: "Buckner",
    region: "Louisville / Jefferson County",
    phone: "(502) 222-7729",
    website: "https://prodigalky.org",
  },
  {
    id: 527,
    name: "Seven Counties Services — Bullitt County",
    category: "Healthcare",
    description: "Community mental health and substance use outpatient services for Bullitt County residents. Seven Counties Services is the CMHC for the greater Louisville region and explicitly serves justice-involved individuals, including those on probation, parole, or recently released from incarceration. Offers counseling, psychiatric evaluation, and medication management.",
    description_es: "Servicios comunitarios de salud mental y uso de sustancias para residentes del Condado de Bullitt. Seven Counties Services es el CMHC de la región de Louisville y sirve explícitamente a personas involucradas con la justicia, incluidas aquellas en libertad condicional o recientemente liberadas.",
    city: "Shepherdsville",
    region: "Louisville / Jefferson County",
    phone: "(502) 589-4313",
    website: "https://sevencounties.org",
  ...
  {
    id: 528,
    name: "Seven Counties Services — Henry / Oldham / Trimble Counties (La Grange)",
    category: "Healthcare",
    description: "Outpatient mental health and substance use services for Henry, Oldham, and Trimble County residents through Seven Counties Services' La Grange office. Serves justice-involved individuals including those on probation or parole. Offers individual therapy, group counseling, psychiatric services, and peer support.",
    description_es: "Servicios ambulatorios de salud mental y uso de sustancias para residentes de los condados de Henry, Oldham y Trimble a través de la oficina de La Grange de Seven Counties Services. Atiende a personas involucradas con la justicia, incluidas las que están en libertad condicional.",
    city: "La Grange",
    region: "Louisville / Jefferson County",
    phone: "(502) 589-4313",
    website: "https://sevencounties.org",
  ...
  {
    id: 529,
    name: "Seven Counties Services — Spencer County",
    category: "Healthcare",
    description: "Outpatient mental health and substance use counseling for Spencer County residents through Seven Counties Services. Serves justice-involved individuals including those reintegrating from incarceration, on probation, or on parole. Services include individual therapy, substance use counseling, psychiatric evaluation, and peer support.",
    description_es: "Consejería ambulatoria de salud mental y uso de sustancias para residentes del Condado de Spencer a través de Seven Counties Services. Atiende a personas involucradas con la justicia, incluidas las que se están reintegrando desde la cárcel, en libertad condicional o supervisada.",
    city: "Taylorsville",
    region: "Louisville / Jefferson County",
    phone: "(502) 589-4313",
    website: "https://sevencounties.org",
  ...
  {
    id: 530,
    name: "NKCAC — Warsaw Office (Gallatin & Surrounding Counties)",
    category: "Financial Assistance",
    description: "Northern Kentucky Community Action Commission satellite office in Warsaw serving Gallatin, Carroll, Grant, and Owen counties. Provides utility assistance (LIHEAP/WAP), emergency financial aid, food referrals, and case management. Explicitly serves individuals with criminal records; reentry clients are encouraged to contact this office for needs-based assistance.",
    description_es: "Oficina satélite de la Comisión de Acción Comunitaria del Norte de Kentucky en Varsovia que sirve a los condados de Gallatin, Carroll, Grant y Owen. Ofrece asistencia de servicios públicos (LIHEAP/WAP), ayuda financiera de emergencia, referencias de alimentos y gestión de casos.",
    address: "212 W. Pullen Ave.",
    city: "Warsaw",
    region: "Northern Kentucky",
    phone: "(859) 428-3939",
    website: "https://nkcac.org",
  ...
  {
    id: 531,
    name: "WestCare — Boyle County Detention Men's Jail Recovery Program",
    category: "Substance Use Treatment",
    description: "In-custody substance use treatment and recovery program for men at the Boyle County Detention Center in Danville. Operated by WestCare Kentucky. Provides intensive group counseling, relapse prevention, life skills, and discharge/reentry planning. Participants may continue outpatient services post-release through WestCare's network.",
    description_es: "Programa de tratamiento de abuso de sustancias y recuperación en custodia para hombres en el Centro de Detención del Condado de Boyle en Danville. Operado por WestCare Kentucky. Ofrece asesoramiento grupal intensivo, prevención de recaídas, habilidades para la vida y planificación de reintegración.",
    city: "Danville",
    region: "Lexington / Fayette County",
    phone: "(606) 546-4052",
    website: "https://westcare.com/place/westcare-kentucky",
  },
  {
    id: 532,
    name: "Probation & Parole — Danville (Boyle County)",
    category: "Probation & Parole",
    description: "Kentucky Department of Corrections Probation & Parole office serving Boyle County. Provides supervision and case management for individuals on felony probation, parole, or conditional discharge in Boyle and surrounding counties. Walk-in hours available; call to confirm reporting schedule.",
    description_es: "Oficina de Libertad Condicional y Libertad Supervisada del Departamento de Correcciones de Kentucky que sirve al Condado de Boyle. Proporciona supervisión y gestión de casos para personas en libertad condicional, libertad supervisada o descarga condicional por delitos graves.",
    address: "315 W. Broadway",
    city: "Danville",
    region: "Lexington / Fayette County",
    phone: "(859) 239-7005",
    website: "https://corrections.ky.gov/ProbationandParole",
  },
  {
    id: 533,
    name: "Bluegrass Community Action Partnership — Boyle County",
    category: "Financial Assistance",
    description: "Community action agency serving Boyle and Garrard counties with utility assistance (LIHEAP), weatherization, emergency financial aid, food referrals, and case management. BCAP serves low-income individuals regardless of criminal history. Reentry clients are encouraged to apply for needs-based programs.",
    description_es: "Agencia de acción comunitaria que sirve a los condados de Boyle y Garrard con asistencia de servicios públicos (LIHEAP), climatización, ayuda financiera de emergencia, referencias de alimentos y gestión de casos. Sirve a personas de bajos ingresos sin importar el historial criminal.",
    address: "1151 N. Danville Bypass",
    city: "Danville",
    region: "Lexington / Fayette County",
    phone: "(859) 236-2700",
    website: "https://bgcap.org",
  },
  {
    id: 534,
    name: "Bluegrass Community Action Partnership — Lincoln County",
    category: "Financial Assistance",
    description: "Community action services for Lincoln County including LIHEAP utility assistance, emergency financial aid, weatherization, and food referrals. BCAP serves low-income clients regardless of criminal history. Stanford office accepts walk-ins; call ahead to confirm hours and available programs.",
    description_es: "Servicios de acción comunitaria para el Condado de Lincoln, incluida asistencia de servicios públicos LIHEAP, ayuda financiera de emergencia, climatización y referencias de alimentos. Sirve a clientes de bajos ingresos sin importar el historial criminal.",
    city: "Stanford",
    region: "Lexington / Fayette County",
    phone: "(606) 365-9577",
    website: "https://bgcap.org",
  ...
  {
    id: 535,
    name: "Cliffview Recovery Center — Lancaster (Garrard County)",
    category: "Substance Use Treatment",
    description: "Residential substance use treatment program located in Lancaster, Garrard County. Operated by Mountain Comprehensive Care Center. Provides long-term residential treatment including individual and group therapy, medication-assisted treatment, life skills, and reentry discharge planning. Accepts individuals referred from courts, jails, and community supervision.",
    description_es: "Programa residencial de tratamiento de abuso de sustancias ubicado en Lancaster, Condado de Garrard. Operado por Mountain Comprehensive Care Center. Ofrece tratamiento residencial a largo plazo que incluye terapia individual y grupal, tratamiento asistido con medicamentos, habilidades para la vida y planificación de reintegración.",
    address: "100 Recovery Ln.",
    city: "Lancaster",
    region: "Lexington / Fayette County",
    phone: "(859) 792-2187",
    website: "https://mtcomp.org",
  },
  {
    id: 536,
    name: "WestCare — Estill County Community Involvement Center",
    category: "Substance Use Treatment",
    description: "Outpatient substance use treatment and reentry support services in Irvine, Estill County. WestCare Kentucky's Community Involvement Center model provides individual and group counseling, case management, and recovery support for justice-involved individuals including those under community supervision or recently released.",
    description_es: "Servicios ambulatorios de tratamiento de abuso de sustancias y apoyo de reintegración en Irvine, Condado de Estill. El modelo de Centro de Participación Comunitaria de WestCare Kentucky ofrece consejería individual y grupal, gestión de casos y apoyo de recuperación para personas involucradas con la justicia.",
    city: "Irvine",
    region: "Eastern Kentucky",
    phone: "(606) 726-0385",
    website: "https://westcare.com/place/westcare-kentucky",
  ...
  {
    id: 537,
    name: "New Vista — Estill County Outpatient Clinic",
    category: "Healthcare",
    description: "Outpatient mental health and substance use counseling for Estill County residents through New Vista (formerly Comprehend), the CMHC for the Bluegrass region. Services include individual therapy, psychiatric evaluation, medication management, and substance use counseling. Serves justice-involved individuals including those on probation or parole in Estill County.",
    description_es: "Consejería ambulatoria de salud mental y uso de sustancias para residentes del Condado de Estill a través de New Vista, el CMHC para la región de Bluegrass. Los servicios incluyen terapia individual, evaluación psiquiátrica, manejo de medicamentos y consejería sobre uso de sustancias.",
    city: "Irvine",
    region: "Eastern Kentucky",
    phone: "(859) 623-5700",
    website: "https://newvistaky.org",
  },
  {
    id: 538,
    name: "NorthKey Community Care — Carroll County",
    category: "Healthcare",
    description: "Outpatient mental health and substance use services for Carroll County residents through NorthKey Community Care, the CMHC for northern Kentucky. NorthKey serves justice-involved individuals including those on probation or parole. Services include individual therapy, substance use counseling, psychiatric evaluation, and peer support referrals.",
    description_es: "Servicios ambulatorios de salud mental y uso de sustancias para residentes del Condado de Carroll a través de NorthKey Community Care, el CMHC para el norte de Kentucky. NorthKey atiende a personas involucradas con la justicia, incluidas las que están en libertad condicional o supervisada.",
    city: "Carrollton",
    region: "Northern Kentucky",
    phone: "(859) 431-1653",
    website: "https://northkey.org",
  },
];
...
const COUNTY_MAP: Record<number, string[]> = {
  ...
  // Scan 2026-06-20 — gap fill: Boyle, Gallatin, Garrard, Lincoln, Bullitt, Oldham, Spencer, Estill, Carroll, Henry, Trimble
  526: ["Oldham"],
  527: ["Bullitt"],
  528: ["Henry", "Oldham", "Trimble"],
  529: ["Spencer"],
  530: ["Gallatin", "Carroll", "Grant", "Owen"],
  531: ["Boyle"],
  532: ["Boyle"],
  533: ["Boyle", "Garrard"],
  534: ["Lincoln"],
