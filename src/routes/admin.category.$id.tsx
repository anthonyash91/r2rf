      ...
      <div className="mt-3 rounded-2xl border border-border bg-card overflow-hidden">
        {(() => {
          const renderItemRow = (item: ContentItem) => {
            ...
            return (
              <div className={`flex flex-col sm:flex-row sm:items-center gap-3 p-4 pl-[14px] pr-[22px] transition-opacity ${isDimmed ? "opacity-40 pointer-events-none" : ""}`}>
                <div className="flex-1 min-w-0 flex flex-col gap-2">
                  ...
                  {item.source && <p className="text-xs text-muted-foreground/80">Source · {item.source}</p>}
                </div>
