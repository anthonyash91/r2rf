...
const VARIANT_CLASSES: Record<ActionButtonVariant, string> = {
  ...
  secondary: "border border-input bg-background text-foreground hover:bg-muted disabled:opacity-60",
  destructive:
 ...
 */
export function actionButtonClassName(variant: ActionButtonVariant = "primary", extra?: string) {
