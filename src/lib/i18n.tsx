...
const translations = {
  en: {
    ...
    "player.play": "Play",
    "player.pause": "Pause",
    "player.playbackSpeed": "Playback speed: {rate}×",
    "player.speed": "Speed",
    "sectionNav.previous": "Previous",
    "sectionNav.upNext": "Up next in this section",
    "sectionNav.continue": "Continue",
    "sectionNav.reachedEnd": "You've reached the end of this section.",
    ...
    "dashboard.errorTitle": "Dashboard didn't load",
    "dashboard.errorGeneric": "Something went wrong.",
    "dashboard.tryAgain": "Try again",
    "forcedReset.tooShort": "Password must be at least 8 characters",
    "forcedReset.mismatch": "Passwords do not match",
    "forcedReset.success": "Password updated",
    "forcedReset.failed": "Failed to update password",
    "forcedReset.newPasswordPlaceholder": "New password (min 8 chars)",
    "forcedReset.confirmPlaceholder": "Confirm new password",
    "forcedReset.title": "Set a new password",
    "forcedReset.description": "For security, please choose a new password before continuing.",
    ...
    "osk.hide": "Hide keyboard",
    "osk.shift": "Shift",
    "osk.backspace": "Backspace",
    "osk.space": "Space",
    "osk.enter": "Enter",
    ...
    "category.noSearchResults": 'No results for "{query}"',
    "category.otherContent": "Other Content",
    ...
    "category.trackProgressVideo": "Watch the video to track your progress",
    "category.trackProgressAudio": "Listen to the audio to track your progress",
    "category.readyToMarkRead": "Give it a moment before marking as read",
    ...
    "signup.pinOrEmailLabel": "PIN or email",
    "signup.pinOrEmailPlaceholder": "Enter your PIN or email",
    ...
    "signup.facilitySearchSelect": "Search and select your facility",
    "signup.facilitySearchPlaceholder": "Search facilities...",
    "signup.facilityNotFound": "No facility found.",
    ...
    "signup.pinOrEmailRequired": "PIN or email is required",
  ...
  es: {
    ...
    "banner.dismiss": "Descartar mensaje",
    "media.video": "Video",
    "media.audio": "Audio",
    "media.image": "Imagen",
    "player.seek": "Buscar",
    ...
    "player.forward15": "Adelantar 15 segundos",
    "player.play": "Reproducir",
    "player.pause": "Pausar",
    "player.playbackSpeed": "Velocidad de reproducción: {rate}×",
    "player.speed": "Velocidad",
    "sectionNav.previous": "Anterior",
    "sectionNav.upNext": "A continuación en esta sección",
    "sectionNav.continue": "Continuar",
    "sectionNav.reachedEnd": "Has llegado al final de esta sección.",
    "error.pageTitle": "Esta página no cargó",
    "error.generic": "Ocurrió un error.",
    "error.tryAgain": "Reintentar",
    "confirm.areYouSure": "¿Estás seguro?",
    ...
    "nav.dashboard": "Panel",
    "dashboard.errorTitle": "El panel no cargó",
    "dashboard.errorGeneric": "Ocurrió un error.",
    "dashboard.tryAgain": "Reintentar",
    "forcedReset.tooShort": "La contraseña debe tener al menos 8 caracteres",
    "forcedReset.mismatch": "Las contraseñas no coinciden",
    "forcedReset.success": "Contraseña actualizada",
    "forcedReset.failed": "No se pudo actualizar la contraseña",
    "forcedReset.newPasswordPlaceholder": "Nueva contraseña (mín. 8 caracteres)",
    "forcedReset.confirmPlaceholder": "Confirma la nueva contraseña",
    "forcedReset.title": "Establece una nueva contraseña",
    "forcedReset.description": "Por seguridad, elige una nueva contraseña antes de continuar.",
    ...
    "osk.hide": "Ocultar teclado",
    "osk.shift": "Mayúsculas",
    "osk.backspace": "Retroceso",
    "osk.space": "Espacio",
    "osk.enter": "Intro",
    ...
    "category.noSearchResults": 'Sin resultados para "{query}"',
    "category.otherContent": "Otro contenido",
    ...
    "category.trackProgressVideo": "Mira el video para registrar tu progreso",
    "category.trackProgressAudio": "Escucha el audio para registrar tu progreso",
    "category.readyToMarkRead": "Espera un momento antes de marcar como leído",
    ...
    "signup.pinOrEmailLabel": "PIN o correo electrónico",
    "signup.pinOrEmailPlaceholder": "Ingresa tu PIN o correo electrónico",
    ...
    "signup.facilitySearchSelect": "Busca y selecciona tu centro",
    "signup.facilitySearchPlaceholder": "Buscar centros...",
    "signup.facilityNotFound": "No se encontró ningún centro.",
    ...
    "signup.pinOrEmailRequired": "El PIN o correo electrónico es obligatorio",
    "signup.facilityMismatch":
