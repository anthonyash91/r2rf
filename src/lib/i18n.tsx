...
const translations: Record<Language, Dict> = {
  en: {
    ...
    "signup.facilityMismatch": "This account doesn't match the one registered to this device. Please sign in with your own personal account.",
    "signup.pinAlreadyRegistered": "The PIN for this device already has an account associated with it. Please sign in with your username and password. If you believe this is an error, contact tech support.",
  ...
  es: {
    ...
    "signup.facilityMismatch": "Esta cuenta no coincide con la registrada en este dispositivo. Por favor inicia sesión con tu propia cuenta personal.",
    "signup.pinAlreadyRegistered": "El PIN de este dispositivo ya tiene una cuenta asociada. Por favor inicia sesión con tu nombre de usuario y contraseña. Si crees que esto es un error, contacta al soporte técnico.",
