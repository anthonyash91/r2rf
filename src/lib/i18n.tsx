...
const translations: Record<Language, Dict> = {
  en: {
    ...
    "signup.pinAlreadyRegistered": "This device already has an account. If it's yours, use the Sign In option below. If you need help, contact your facility.",
  ...
  es: {
    ...
    "signup.pinAlreadyRegistered": "Este dispositivo ya tiene una cuenta registrada. Si es tuya, usa la opción de Iniciar sesión. Si necesitas ayuda, contacta a tu institución.",
