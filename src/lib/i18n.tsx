...
const translations: Record<Language, Dict> = {
  en: {
    ...
    "signup.facilityMismatch": "The account you're trying to sign into's PIN doesn't match the PIN signed into this device. Please sign in with your own account.",
  ...
  es: {
    ...
    "signup.facilityMismatch": "El PIN de la cuenta en la que intentas iniciar sesión no coincide con el PIN registrado en este dispositivo. Por favor inicia sesión con tu propia cuenta.",
