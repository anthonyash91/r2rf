...
const translations: Record<Language, Dict> = {
  en: {
    ...
    "signup.noFacilityBlock": "Sign up is only available through a facility link. If you need an account, please contact your facility administrator.",
  ...
  es: {
    ...
    "signup.noFacilityBlock": "El registro solo está disponible a través de un enlace de institución. Si necesitas una cuenta, por favor contacta al administrador de tu institución.",
