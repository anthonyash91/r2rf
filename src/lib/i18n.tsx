...
const translations: Record<Language, Dict> = {
  en: {
    ...
    "signup.facilityMismatch": "This account is not registered for this facility or PIN. Please check your link and try again.",
  ...
  es: {
    ...
    "signup.facilityMismatch": "Esta cuenta no está registrada para esta instalación o PIN. Por favor verifique su enlace e intente nuevamente.",
