...
const translations: Record<Language, Dict> = {
  en: {
    ...
    "signup.facilityMismatch": "It looks like you're signing into the wrong account. Only the account linked to this tablet's PIN can sign in here — the PIN in your link must match the account you're trying to access.",
  ...
  es: {
    ...
    "signup.facilityMismatch": "Parece que estás intentando iniciar sesión en la cuenta equivocada. Solo la cuenta vinculada al PIN de esta tableta puede iniciar sesión aquí: el PIN de tu enlace debe coincidir con la cuenta a la que intentas acceder.",
