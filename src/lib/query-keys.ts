...
export const QK = {
  ...
  categoriesPublic: (facilityValue: string) => ["categories", "public", facilityValue] as const,
  ...
  facilityBySiteParam: (site: string | null) => ["facility-by-site-param", site] as const,
  ...
  facilityCategories: (facilityValue: string) => ["facility-categories", facilityValue] as const,
  ...
  myAchievements: (userId: string | undefined) => ["my-achievements", userId] as const,
  myBookmarkIds: (userId: string | undefined) => ["my-bookmark-ids", userId] as const,
  myBookmarkedItems: (userId: string | undefined) => ["my-bookmarked-items", userId] as const,
  myRatings: (userId: string | undefined) => ["my-ratings", userId] as const,
  myEngagementTier: (userId: string | undefined) => ["my-engagement-tier", userId] as const,
  myMonthlySummary: (userId: string | undefined) => ["my-monthly-summary", userId] as const,
  myLoginDays: (userId: string | null | undefined) => ["my-login-days", userId] as const,
  myTestRuns: ["my-test-runs"] as const,
  myTestRunResults: (runId: string | null) => ["my-test-run-results", runId] as const,
  resumeItem: (userId: string | undefined) => ["resume-item", userId] as const,
  testerProfile: (userId: string | undefined) => ["tester-profile", userId] as const,
  ...
  homeUserProgress: (userId: string | undefined) => ["home-user-progress", userId] as const,
  ...
  inmatePinCheck: (facilityValue: string | undefined, pin: string | null) =>
  ...
  adminIconsBadgesContentTypes: ["admin", "icons-badges", "content-types"] as const,
  ...
  adminTestRunDetail: (runId: string | null) => ["admin", "test-run-detail", runId] as const,
  adminNewUsersCount: (lastSeen: string | null) => ["admin", "new-users-count", lastSeen] as const,
  adminSiteSettings: (key: string) => ["admin", "site_settings", key] as const,
  adminReport: (kind: string, facilityValue: string | null, range: string) =>
  ...
  adminUserProgress: (userId: string) => ["admin", "user-progress", userId] as const,
  adminUserMonthlySummary: (userId: string) => ["admin", "user-monthly-summary", userId] as const,
