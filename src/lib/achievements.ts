...
export const ACHIEVEMENTS: Achievement[] = [
  // First steps
  {
    ...
    description: "Complete your first content item",
    icon: "BookOpen",
  ...
  },
  {
    key: "items_25",
    title: "25 Resources",
    description: "Complete 25 content items",
    icon: "CheckCircle2",
    category: "completion",
  },
  {
    key: "items_50",
    title: "50 Resources",
    description: "Complete 50 content items",
    icon: "Award",
    category: "completion",
  },
  {
    key: "items_100",
    title: "100 Resources",
    description: "Complete 100 content items",
    icon: "Trophy",
    category: "completion",
  },
  {
    key: "program_1",
    title: "Category graduate",
    description: "Complete all items in a category",
    icon: "GraduationCap",
    category: "completion",
  },
  {
    key: "program_5",
    title: "5 categories finished",
    description: "Complete all items in 5 categories",
    icon: "Medal",
    category: "completion",
  },
  ...
  // Time
  {
    key: "time_5h",
    title: "5 Hours In",
    description: "Spend 5 hours actively learning",
    icon: "Clock",
    category: "time",
  },
  {
    key: "time_10h",
    title: "10 Hours In",
    description: "Spend 10 hours actively learning",
    icon: "Clock",
    category: "time",
  },
  {
    key: "time_50h",
    title: "50 Hours In",
    description: "Spend 50 hours actively learning",
    icon: "Clock",
    category: "time",
  },
];
