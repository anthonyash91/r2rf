...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      report_bulk_user_engagement: {
        Args: { p_user_ids: string[] };
        Returns: {
          content_item_id: string;
          manual_completion_pct: number;
          media_duration_seconds: number;
          media_progress_seconds: number;
          session_seconds: number;
          user_id: string;
        }[];
      };
      report_bulk_user_logins: {
        Args: { p_user_ids: string[] };
        Returns: {
          login_date: string;
          user_id: string;
